...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Takes an argument providing default variabel for the 
    # first of the agruments to the block. The first argument
    # is the variable and the second is the current value.
    # Does some action on the first variable in the || in the block,
    # likely involving the current item in the list and then returns the
    # final value of the variable in ||
  end
